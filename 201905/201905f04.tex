...
ötödik osztály, 2019. május, 4/10
\stoplinealignment
...
{\starttabulate[|Mcw(\dimexpr0.25\textwidth-0.75em\relax)|Mcw(\dimexpr0.25\textwidth-0.75em\relax)|Mcw(\dimexpr0.25\textwidth-0.75em\relax)|Mcw(\dimexpr0.25\textwidth-0.75em\relax)|]
  \NC {\fraction{488}{488}} \NC {\fraction{72}{81}} \NC {\fraction{30}{25}} \NC {\fraction{702}{2106}}\NR \TB[line]
 \NC {\fraction{7}{14}} \NC {\fraction{1565}{1565}} \NC {\fraction{507}{676}} \NC {\fraction{14}{10}}\NR \TB[line]
 \NC {\fraction{16}{18}} \NC {\fraction{21}{28}} \NC {\fraction{288}{288}} \NC {\fraction{81}{18}}\NR \TB[line]
...
{\starttabulate[|Mcw(\dimexpr0.33\textwidth-0.67em\relax)|Mcw(\dimexpr0.34\textwidth-0.66em\relax)|Mcw(\dimexpr0.33\textwidth-0.67em\relax)|]
  \NC {\fraction{9}{24}} \NC {\fraction{318}{73}} \NC {\fraction{8}{9}}\NR \TB[line]
 \NC {\fraction{7}{58}} \NC {\fraction{7}{4}} \NC {\fraction{1}{91}}\NR \TB[line]
 \NC {\fraction{70}{63}} \NC {\fraction{87}{98}} \NC {\fraction{0}{88}}\NR \TB[line]
...
%{\starttabulate[|Mcw(\dimexpr0.5\textwidth-0.5em\relax)|Mcw(\dimexpr0.5\textwidth-0.5em\relax)|]
  \NC {\fraction{3}{69}}-{\fraction{0}{69}} \NC {\fraction{7}{2}}-{\fraction{3}{2}} \NC {\fraction{10}{9}}+{\fraction{95}{9}}\NR \TB[line]
 \NC {\fraction{87}{4}}-{\fraction{31}{4}} \NC {\fraction{7}{65}}+{\fraction{85}{65}} \NC {\fraction{2}{6}}-{\fraction{1}{6}}\NR \TB[line]
 \NC {\fraction{4}{67}}-{\fraction{2}{67}} \NC {\fraction{86}{28}}+{\fraction{18}{28}} \NC {\fraction{27}{3}}-{\fraction{1}{3}}\NR \TB[line]
 \NC {\fraction{82}{43}}+{\fraction{39}{43}} \NC {\fraction{795}{5}}-{\fraction{11}{5}} \NC {\fraction{23}{7}}-{\fraction{2}{7}}\NR \TB[line]
...
{\starttabulate[|Mcw(\dimexpr0.33\textwidth-0.67em\relax)|Mcw(\dimexpr0.34\textwidth-0.66em\relax)|Mcw(\dimexpr0.33\textwidth-0.67em\relax)|]
%{\starttabulate[|Mcw(\dimexpr0.5\textwidth-0.5em\relax)|Mcw(\dimexpr0.5\textwidth-0.5em\relax)|]
  \NC {\fraction{82}{92}}+{\fraction{67}{53}} \NC {\fraction{433}{125}}-{\fraction{6}{8}} \NC {\fraction{89}{63}}+{\fraction{6}{548}}\NR \TB[line]
 \NC {\fraction{5}{8}}-{\fraction{9}{67}} \NC {\fraction{147}{14}}+{\fraction{56}{565}} \NC {\fraction{729}{62}}-{\fraction{1}{4}}\NR \TB[line]
 \NC {\fraction{55}{74}}+{\fraction{641}{9}} \NC {\fraction{35}{5}}-{\fraction{51}{25}} \NC {\fraction{43}{80}}-{\fraction{2}{57}}\NR \TB[line]
 \NC {\fraction{1}{69}}+{\fraction{15}{892}} \NC {\fraction{9}{84}}+{\fraction{31}{9}} \NC {\fraction{0}{28}}+{\fraction{65}{36}}\NR \TB[line]
...
{\starttabulate[|cw(\dimexpr0.33\textwidth-0.67em\relax)|cw(\dimexpr0.34\textwidth-0.66em\relax)|cw(\dimexpr0.33\textwidth-0.67em\relax)|]
  \NC 1000\,g \NC 64310\,dm \NC 72\,s\NR 
 \NC 5085\,m\high{3} \NC 5\,h \NC 1\,d\NR 
 \NC 7691\,ha \NC 36\,min \NC 4\,m\NR 
 \NC 9\,km \NC 96\,kg \NC 7000\,l\NR 
 \NC 2200\,cm \NC 457000\,mm \NC 70\,m\high{2}\NR 
 \NC 1\,t \NC 3\,dkg \NC 6000000\,mg\NR 
...
{\starttabulate[|Mcw(0.5\textwidth)||Mcw(0.5\textwidth)|][unit=0pt]
  \NC \text{7446\,mm\high{2}} = \text{\dots\,ha} \NC \text{9679\,mm\high{3}} = \text{\dots\,cl}\NR 
 \NC \text{942\,cm\high{2}} = \text{\dots\,km\high{2}} \NC \text{88\,dl} = \text{\dots\,l}\NR 
 \NC \text{19\,s} = \text{\dots\,d} \NC \text{23\,g} = \text{\dots\,kg}\NR 
 \NC \text{17\,min} = \text{\dots\,h} \NC \text{375\,h} = \text{\dots\,d}\NR 
 \NC \text{4271\,dm\high{2}} = \text{\dots\,ha} \NC \text{9\,m\high{2}} = \text{\dots\,ha}\NR 
 \NC \text{391\,cm\high{2}} = \text{\dots\,km\high{2}} \NC \text{67\,m} = \text{\dots\,km}\NR 
 \NC \text{359\,dm\high{2}} = \text{\dots\,ha} \NC \text{852\,s} = \text{\dots\,min}\NR 
 \NC \text{510\,cm\high{2}} = \text{\dots\,dm\high{2}} \NC \text{293\,t} = \text{\dots\,t}\NR 
 \NC \text{1514\,dm\high{3}} = \text{\dots\,hl} \NC \text{4\,min} = \text{\dots\,d}\NR 
 \NC \text{5508\,mm\high{2}} = \text{\dots\,m\high{2}} \NC \text{630\,mg} = \text{\dots\,dkg}\NR 
