...
ötödik osztály, 2019. május, 3/10
\stoplinealignment
...
{\starttabulate[|Mcw(\dimexpr0.25\textwidth-0.75em\relax)|Mcw(\dimexpr0.25\textwidth-0.75em\relax)|Mcw(\dimexpr0.25\textwidth-0.75em\relax)|Mcw(\dimexpr0.25\textwidth-0.75em\relax)|]
  \NC {\fraction{8}{64}} \NC {\fraction{9}{6}} \NC {\fraction{329}{188}} \NC {\fraction{63}{18}}\NR \TB[line]
 \NC {\fraction{4674}{6232}} \NC {\fraction{36}{54}} \NC {\fraction{810}{810}} \NC {\fraction{536}{2144}}\NR \TB[line]
 \NC {\fraction{2988}{4980}} \NC {\fraction{102}{136}} \NC {\fraction{5}{5}} \NC {\fraction{94}{376}}\NR \TB[line]
...
{\starttabulate[|Mcw(\dimexpr0.33\textwidth-0.67em\relax)|Mcw(\dimexpr0.34\textwidth-0.66em\relax)|Mcw(\dimexpr0.33\textwidth-0.67em\relax)|]
  \NC {\fraction{54}{8}} \NC {\fraction{5}{51}} \NC {\fraction{35}{46}}\NR \TB[line]
 \NC {\fraction{31}{18}} \NC {\fraction{5}{39}} \NC {\fraction{9}{3}}\NR \TB[line]
 \NC {\fraction{21}{2}} \NC {\fraction{18}{73}} \NC {\fraction{69}{8}}\NR \TB[line]
...
%{\starttabulate[|Mcw(\dimexpr0.5\textwidth-0.5em\relax)|Mcw(\dimexpr0.5\textwidth-0.5em\relax)|]
  \NC {\fraction{16}{20}}+{\fraction{4}{20}} \NC {\fraction{892}{1}}+{\fraction{1}{1}} \NC {\fraction{709}{71}}-{\fraction{698}{71}}\NR \TB[line]
 \NC {\fraction{18}{40}}-{\fraction{2}{40}} \NC {\fraction{424}{1}}+{\fraction{6}{1}} \NC {\fraction{83}{4}}-{\fraction{80}{4}}\NR \TB[line]
 \NC {\fraction{70}{37}}-{\fraction{5}{37}} \NC {\fraction{936}{26}}-{\fraction{493}{26}} \NC {\fraction{27}{9}}+{\fraction{92}{9}}\NR \TB[line]
 \NC {\fraction{98}{7}}+{\fraction{686}{7}} \NC {\fraction{69}{15}}-{\fraction{4}{15}} \NC {\fraction{57}{5}}-{\fraction{17}{5}}\NR \TB[line]
...
{\starttabulate[|Mcw(\dimexpr0.33\textwidth-0.67em\relax)|Mcw(\dimexpr0.34\textwidth-0.66em\relax)|Mcw(\dimexpr0.33\textwidth-0.67em\relax)|]
%{\starttabulate[|Mcw(\dimexpr0.5\textwidth-0.5em\relax)|Mcw(\dimexpr0.5\textwidth-0.5em\relax)|]
  \NC {\fraction{9}{8}}+{\fraction{2}{89}} \NC {\fraction{23}{2}}-{\fraction{4}{199}} \NC {\fraction{30}{93}}+{\fraction{50}{67}}\NR \TB[line]
 \NC {\fraction{1}{5}}+{\fraction{0}{3}} \NC {\fraction{2}{1}}-{\fraction{36}{481}} \NC {\fraction{5}{517}}+{\fraction{26}{6}}\NR \TB[line]
 \NC {\fraction{36}{3}}+{\fraction{5}{68}} \NC {\fraction{4}{2}}-{\fraction{10}{7}} \NC {\fraction{95}{1}}-{\fraction{38}{66}}\NR \TB[line]
 \NC {\fraction{9}{3}}-{\fraction{2}{6}} \NC {\fraction{10}{2}}-{\fraction{7}{19}} \NC {\fraction{97}{12}}-{\fraction{61}{8}}\NR \TB[line]
...
{\starttabulate[|cw(\dimexpr0.33\textwidth-0.67em\relax)|cw(\dimexpr0.34\textwidth-0.66em\relax)|cw(\dimexpr0.33\textwidth-0.67em\relax)|]
  \NC 6\,m\high{2} \NC 78\,min \NC 9000000\,mg\NR 
 \NC 2\,d \NC 6\,m\high{3} \NC 4527000\,mm\NR 
 \NC 2000\,l \NC 50\,dm \NC 9\,kg\NR 
 \NC 18\,h \NC 5\,t \NC 3984\,dkg\NR 
 \NC 300\,cm \NC 19\,km \NC 69\,s\NR 
 \NC 6\,ha \NC 3000\,g \NC 9\,m\NR 
...
{\starttabulate[|Mcw(0.5\textwidth)||Mcw(0.5\textwidth)|][unit=0pt]
  \NC \text{569\,g} = \text{\dots\,dkg} \NC \text{2\,min} = \text{\dots\,h}\NR 
 \NC \text{753\,m\high{2}} = \text{\dots\,ha} \NC \text{628\,s} = \text{\dots\,d}\NR 
 \NC \text{823\,t} = \text{\dots\,t} \NC \text{615\,s} = \text{\dots\,min}\NR 
 \NC \text{5\,mm\high{2}} = \text{\dots\,ha} \NC \text{4609\,mg} = \text{\dots\,kg}\NR 
 \NC \text{721\,mm} = \text{\dots\,cm} \NC \text{505\,dm} = \text{\dots\,km}\NR 
 \NC \text{46\,l} = \text{\dots\,l} \NC \text{2063\,mm} = \text{\dots\,km}\NR 
 \NC \text{5\,dm} = \text{\dots\,m} \NC \text{15\,cm} = \text{\dots\,m}\NR 
 \NC \text{7\,mm} = \text{\dots\,dm} \NC \text{5876\,h} = \text{\dots\,d}\NR 
 \NC \text{6\,mm\high{3}} = \text{\dots\,m\high{3}} \NC \text{16\,dl} = \text{\dots\,km\high{3}}\NR 
 \NC \text{6855\,mg} = \text{\dots\,kg} \NC \text{344\,mm} = \text{\dots\,cm}\NR 
