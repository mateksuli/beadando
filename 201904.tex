...
A dolgozatot külön lapon vagy lapokon, A4-es fénymásolópapíron kérem beadni.
Szép munkákat várok.
Azt javaslom először dolgozzatok külön munkalapra (ami lehet akár egy spirálfüzetből kitépett négyzetrácsos lap is), aztán ha végeztetek a feladattal, másoljátok szépen át a beadandó lapjára.
Minden esetben tollal dolgozzatok!
Ha valamit nem tudtatok megoldani, akkor adjátok be a hozzá tartozó munkalapot, hogy tudjam értékelni a próbálkozást, és lássam, hogy mi okozott gondot: ezt a következő órákon majd át tudjuk beszélni.
A munkalapokon ki ne satírozzatok semmit, egy vagy két vonallal áthúzni viszont természetesen szabad bármit.
Az elbírálás során a beadandó lap természetesen nagyobb súllyal bír, de ha a munkalapon látom, hogy volt valamiféle próbálkozás a feladat megoldására, akkor azt is fogom értékelni.
...
Add össze a számokat 1-től 100-ig, az 1-el kezdve és a 100-al befejezve.
\stopfeladat
\blank
